...
public class DrivingLicence {
	...
	/*
	 * declaring previous experience variable, if the immigrant having more than 2
	 * year of experience from his back home can also give G test after passing G1.
	 */
	...
	void isDrivingLicenceIssued() {
		...
		isClassGPass = (isClassG1Pass && age >= 18 && previousExperience >= 2)
				|| (isClassG2Pass && isHighwayRoadTestPass && noOfMonthsSinceG2Passed >= 8);
